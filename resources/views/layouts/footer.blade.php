<!-- Footer-->
        ...
        <div class="container">
          <div class="row">
            <div class="info col-lg-4">
              <div class="logo"><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/logo-white.png" alt="..."></div>
          ...
          <div class="row d-flex align-items-center">
            ...
            <div class="payment col-md-6 clearfix">
              <ul class="payment-list list-inline-item pull-right">
                <li class="list-inline-item"><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/visa.svg" alt="..."></li>
                <li class="list-inline-item"><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/mastercard.svg" alt="..."></li>
                <li class="list-inline-item"><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/paypal.svg" alt="..."></li>
                <li class="list-inline-item"><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/western-union.svg" alt="..."></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div id="style-switch" class="collapse">
      ...
      <p><img src="https://d19m59y37dris4.cloudfront.net/hub/1-3-1/img/template-mac.png" alt="" class="img-fluid"></p>
