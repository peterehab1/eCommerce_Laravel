    ...
    <main class="contact-page">
      ...
      <section>
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-7">
              <form id="contact-form" method="post" action="{{ route('sendForm') }}" class="custom-form form">
                @csrf
                <div class="controls">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="first_name" id="name" placeholder="Enter your firstname" required="required" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="surname" class="form-label">Your lastname *</label>
                        <input type="text" name="last_name" id="surname" placeholder="Enter your  lastname" required="required" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
